...
for idx_num in range(35):
  ...
  while(num_epoch==idx_num):
      ...
      with tf.Session() as sess:
          ...
          sess.run(init_op)
          data_ir=prepare_data('/home/root3203/lishanshan/TheWholeBrainAtlas_After/test/MR-T1')
          data_vi=prepare_data('/home/root3203/lishanshan/TheWholeBrainAtlas_After/test/MR-T2')
